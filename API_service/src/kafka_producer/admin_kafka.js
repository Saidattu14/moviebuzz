...
class KafkaAdmin {
    constructor()
    {
        ...
        // client.deleteTopic('Ticket_Booking',10000,function(err) {
        //     console.log(err)
        // });
        // client.deleteTopic('Trending_Movies',10000,function(err) {
        //     console.log(err)
        // });
        // client.deleteTopic('Get_Movies_By_Search',10000,function(err) {
        //     console.log(err)
        // });
